...
Route::post('/save-booking-request', [App\Http\Controllers\Ajax::class, 'bookingRequest']);
Route::post('/save-booking-event', [App\Http\Controllers\Ajax::class, 'eventBooking']);
