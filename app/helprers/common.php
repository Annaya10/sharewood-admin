...
function get_blog_cats($id, $table_name = 'blog_categories')
{
...
{
    if ($status == '1') {
        return '<span class="badge text-success bg-success-subtle">Approved</span>';
    } else if ($status == '2') {
        return '<span class="badge text-warning bg-warning-subtle">Denied</span>';
    } else if ($status == '3') {
        return '<span class="badge text-danger bg-danger-subtle">Cancelled</span>';
    } else {
        return '<span class="badge text-secondary  bg-secondary-subtle">Pending</span>';
    }
}
