        ...
        <div class="card-body">
            ...
            <div class="col-md-12">
                    <div class="row">
                        <div class="col">
                        <div class="mb-3">
                            <label class="form-label" for="sec2_heading">Note Heading</label>
                            <textarea id="sec2_heading" name="sec2_heading" rows="4" class=" editor">{{ !empty($sitecontent['sec2_heading']) ? $sitecontent['sec2_heading'] : "" }}</textarea>
