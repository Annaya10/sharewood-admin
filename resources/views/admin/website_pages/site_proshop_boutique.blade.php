            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label" for="section1_gheading"> Golden Heading</label>
                                <input class="form-control" id="section1_gheading" type="text"
                                    name="section1_gheading" placeholder=""
                                    value="{{ !empty($sitecontent['section1_gheading']) ? $sitecontent['section1_gheading'] : '' }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
...
<div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="section3_text" type="text"
                            name="section3_text" placeholder=""
                            value="{{ !empty($sitecontent['section3_text']) ? $sitecontent['section3_text'] : '' }}">
                    </div>
                </div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <?php $club_house_services = 0; ?>
        @for ($i = 2; $i <= 5; $i++)
            <?php $club_house_services = $club_house_services + 1; ?>
            <div class="col-6">
                <div class="card">

                    <div class="card-header">
                        <h5>Block {{ $club_house_services }}</h5>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-2">
                                    <label class="form-label"
                                        for="sec4_text{{ $i }}">Text
                                        {{ $club_house_services }}</label>
                                    <textarea id="sec4_text{{ $i }}" name="sec4_text{{ $i }}" rows="4"
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="mb-3">
                                ...
                                <textarea id="section5_text" name="section5_text" rows="4" class=" form-control">{{ !empty($sitecontent['section5_text']) ? $sitecontent['section5_text'] : "" }}</textarea>
                            </div>
                        </div>
