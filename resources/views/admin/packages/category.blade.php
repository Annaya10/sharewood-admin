...
@if (request()->segment(3) == 'edit' || request()->segment(3) == 'add')
    {!!breadcrumb('Add/Update Package Category')!!}
...
@else
{!!breadcrumb('Packages Categories',url('admin/package_categories/add/'))!!}
<div class="card">
  <div class="card-body">
      <div class="row">
                      ...
                      <td>
                          <div class="dropdown dropstart">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <li>
                                  <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/package_categories/edit/' . $row->id) }}">
                                    <i class="fs-4 ti ti-edit"></i>Edit
                                  </a>
                                </li>
                                <li>
                                  <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/package_categories/delete/' . $row->id) }}"  onclick="return confirm('Are you sure?');">
