...
{!!breadcrumb('Add/Update Packages')!!}
...
@else
{!!breadcrumb('Packages',url('admin/packages/add/'))!!}
<div class="card">
  <div class="card-body">
    <div class="row">
              ...
              <td>
                <div class="dropdown dropstart">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <li>
                      <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/packages/edit/' . $row->id) }}">
                        <i class="fs-4 ti ti-edit"></i>Edit
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/packages/delete/' . $row->id) }}" onclick="return confirm('Are you sure?');">
