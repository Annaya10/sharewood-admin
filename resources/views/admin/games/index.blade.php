...
{!!breadcrumb('Add/Update Products & Capabilities')!!}
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                <div class="file_choose_icon">
                                    <img src="{{ get_site_image_src('products', !empty($row) ? $row->image : '') }}" alt="matdash-img" class="img-fluid" width="120" height="120">
                                </div>
                ...
                <div class="col-lg-6 d-flex align-items-stretch">
                    <div class="card w-100 border position-relative overflow-hidden">
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch py-2">
                                    <input class="form-check-input success" type="checkbox" id="color-success2" {{ !empty($row) ? ($row->is_featured == 1 ? 'checked' : '') : '' }} name="featured" />
                                    <label class="form-check-label" for="color-success2"> {{ !empty($row) ? ($row->is_featured == 0 ? 'InActive' : 'Active') : 'Featured' }}</label>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="heading_1"
                                            value="{{!empty($row->heading_1) ? $row->heading_1 : ""}}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="block_1" class="form-label">Block 1</label>
                                        <textarea class="editor" name="block_1">{{ !empty($row) ? $row->block_1 : '' }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="heading_2"
                                            value="{{!empty($row->heading_2) ? $row->heading_2 : ""}}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="block_2" class="form-label">Block 2</label>
                                        <textarea class="editor" name="block_2">{{ !empty($row) ? $row->block_2 : '' }}</textarea>
                                    </div>
                                </div>
                            </div> -->
                        </div>
...
@else
{!!breadcrumb('Manage Games',url('admin/games/add/'))!!}
<div class="card">
    <div class="card-body">
        <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-6 crud_thumbnail_icon">
                                        <img src="{{ get_site_image_src('games', !empty($row->image) ? $row->image : '') }}" width="45" class="rounded-circle" />
                                ...
                                <td>
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/games/edit/' . $row->id) }}">
                                                    <i class="fs-4 ti ti-edit"></i>Edit
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/games/delete/' . $row->id) }}" onclick="return confirm('Are you sure?');">
                                                    <i class="fs-4 ti ti-trash"></i>Delete
                                                </a>
                                            </li>

                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/games/levels/' . $row->id) }}" >
