...
@php
    $game_id = request()->segment(4); 
@endphp
@if (request()->segment(4) == 'edit' || request()->segment(4) == 'add')
{!!breadcrumb('Add/Update Levels ')!!}
                    ...
                    <div class="card w-100 border position-relative overflow-hidden">
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="price" value="{{!empty($row->price) ? $row->price : ""}}">
                            </div>
...
@else
{!! breadcrumb('Manage Levels', url("admin/games/levels/add/$game_id")) !!}
                                ...
                                <td>
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/games/levels/edit/' . $row->id) }}">
                                                    <i class="fs-4 ti ti-edit"></i>Edit
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/games/levels/delete/' . $row->id) }}" onclick="return confirm('Are you sure?');">
