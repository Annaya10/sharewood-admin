...
{!!breadcrumb('Add/Update Sponsership')!!}
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                <div class="file_choose_icon">
                                    <img src="{{ get_site_image_src('sponsership', !empty($row) ? $row->image : '') }}" alt="matdash-img" class="img-fluid" width="120" height="120">
                                </div>
...
@else
{!!breadcrumb('Manage Sponsership',url('admin/sponsership/add/'))!!}
<div class="card">
    <div class="card-body">
        <div class="row">
                    ...
                    <table id="zero_config" class="table table-striped table-bordered text-nowrap align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="">
                                        <img src="{{ get_site_image_src('sponsership', !empty($row->image) ? $row->image : '') }}" width="100" class="" />
                                ...
                                <td>
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/sponsership/edit/' . $row->id) }}">
                                                    <i class="fs-4 ti ti-edit"></i>Edit
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/sponsership/delete/' . $row->id) }}" onclick="return confirm('Are you sure?');">
