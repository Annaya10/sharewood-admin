                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>Thanks for Contacting with {{$site_settings->site_name}}! Below are your Contact Details:</p>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td>
                                                    <b>Name: </b>{{ $content['content']['name'] }}<br />
                                                    <b>Phone: </b> {{ $content['content']['phone'] }}<br />
                                                    <b>Email: </b> {{ $content['content']['email'] }}<br />
                                                    <b>Hear About: </b> {{ $content['content']['hear_about'] }}<br />
                                                    <b>Message: </b> {{ $content['content']['message'] }}<br />
